...
equals(QT_ARCH, "arm64"): STAGING = $$(HOME)/ps/staging-aarch64
equals(QT_ARCH, "arm"):   STAGING = $$(HOME)/ps/staging-armv7hl
equals(QT_ARCH, "i386"):  STAGING = $$(HOME)/ps/staging-i486
